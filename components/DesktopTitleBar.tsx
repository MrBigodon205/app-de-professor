...
export const DesktopTitleBar: React.FC = () => {
    ...
    return (
        <div
            className="fixed top-0 left-0 right-0 h-[28px] bg-[#0f172a] border-b border-white/10 flex items-center justify-between px-4 z-[999] select-none shadow-md overflow-hidden electron-drag"
        ...
        >
            ...
            <div className="flex items-center h-full electron-no-drag">
                <button
                    ...
                    className="h-full px-3 hover:bg-white/10 text-white/80 hover:text-white transition-colors"
                    title="Minimizar"
                >
                    <span className="material-symbols-outlined text-[16px] opacity-70">minimize</span>
                </button>
                <button
                ...
                >
                    <span className="material-symbols-outlined text-[16px] opacity-70">crop_square</span>
                </button>
                <button
